...
const Blog = () => {
    ...
    return (
        <div className="w-full py-16 sm:py-20 bg-gray-50 perspective-1200">
  <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
    ...
    <motion.h2
      ...
      viewport={{ once: true }}
      className={`text-3xl sm:text-4xl font-extrabold text-${primaryColor} mb-4`}
    >
      📰 Club Insights & News
    </motion.h2>
    ...
    <motion.p
      ...
      viewport={{ once: true }}
      className="text-gray-600 mb-10 sm:mb-12 text-base sm:text-lg"
    >
        ...
        >
          ...
          <div className="p-5 sm:p-6 flex-grow flex flex-col">
            ...
            <motion.div
              ...
              className={`
                text-left mb-3 inline-flex items-center gap-1
                bg-${primaryLight} text-${primaryColor}
            ...
            <h3
              className={`
                text-xl sm:text-2xl font-bold mb-3 text-left
                text-gray-900 hover:text-${primaryColor}
            ...
            <p className="text-gray-600 mb-5 text-left flex-grow text-sm sm:text-base">
              {blog.desc}
            </p>

            {/* Metadata */}
            <div className="flex flex-wrap gap-3 items-center justify-between text-gray-500 text-xs sm:text-sm border-t border-gray-100 pt-4 mt-auto">
              <span className="flex items-center gap-1">
                <FaUser className="h-3 w-3" /> {blog.author}
              </span>
              <span className="flex items-center gap-1">
                <FaCalendarAlt className="h-3 w-3" /> {blog.date}
              </span>
            </div>
          </div>
