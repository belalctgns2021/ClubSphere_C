      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        {clubs.map((club, index) => (
          <motion.div
            ...
            whileTap={{ scale: 0.98 }}
            className="bg-white rounded-2xl overflow-hidden cursor-pointer shadow-lg border border-gray-100 flex flex-col transition-all duration-300"
          >
            {/* Club Image */}
