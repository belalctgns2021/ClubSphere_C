...
const Contact = () => {
    ...
    return (
       // Container wrapper for 3D effect
<div className="min-h-screen w-11/12 max-w-7xl mx-auto bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 perspective-1000">
    <motion.div 
        className="mx-auto bg-white shadow-2xl rounded-xl overflow-hidden transform-gpu"
    ...
    >
        ...
        <div className="lg:grid lg:grid-cols-3 gap-0">
            ...
            <motion.div 
                className="bg-gray-800 p-8 text-white lg:col-span-1 space-y-8 transform-gpu"
                variants={itemVariants}
            ...
            >
                ...
                <div className="flex items-start space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400">any where at </p>
                    </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400">imhere@gmail.com</p>
                    </div>
                </div>
            </motion.div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <motion.div variants={itemVariants}>
                        ...
                        <input
                            ...
                            name="name"
                            required
                            className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-3 focus:ring-indigo-500 focus:border-indigo-500 transition duration-300 transform-gpu"
                    ...
                    <motion.div variants={itemVariants}>
                        <motion.button
                            ...
                            whileHover={{ scale: 1.05, boxShadow: "0 10px 20px rgba(99, 102, 241, 0.4)", rotateY: 5 }}
                            whileTap={{ scale: 0.98 }}
