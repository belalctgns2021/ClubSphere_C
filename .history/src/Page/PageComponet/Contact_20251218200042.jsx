...
const Contact = () => {
    ...
    className="w-full bg-gradient-to-r from-pink-200 to-yellow-200 shadow-lg sticky top-0 z-50 transition-all duration-300"
>
    <div className="navbar w-9/12 mx-auto px-4 py-2">
        ...
        <div className="navbar-start">
            <div className="dropdown">
                ...
                <ul
                    tabIndex={0}
                    className="menu menu-sm dropdown-content bg-white rounded-box z-[1] mt-3 w-64 p-4 shadow-xl border border-pink-300 space-y-2 text-gray-800"
                >
                    {Linkss}
                </ul>
            </div>
            ...
            {user ? (
                <div className="dropdown dropdown-end">
                    <div
                        tabIndex={0}
                        role="button"
                        className="btn btn-ghost btn-circle avatar border-2 border-pink-400 p-0 m-0 hover:shadow-lg hover:shadow-pink-400/50 transition-shadow"
                    ...
                    <ul
                        tabIndex={0}
                        className="menu menu-sm dropdown-content bg-white rounded-box z-[1] mt-3 w-64 p-3 shadow-xl border border-pink-300 space-y-1 text-gray-800"
                    >
                        {/* Profile Info */}
                        <li className='px-3 py-2 font-bold border-b border-pink-300 mb-1 flex flex-col'>
                            <span className="flex items-center gap-2">
                                <FaUserCircle className='text-lg text-pink-500' />
